...
Gosto de transformar ideias em sistemas funcionais e, principalmente, de aprender desenvolvendo. Atualmente, venho explorando diferentes tecnologias para entender melhor tanto o desenvolvimento web quanto o backend.
...
- 🏥 **Hospital CRUD** — projeto voltado para operações de cadastro e gerenciamento de dados.
